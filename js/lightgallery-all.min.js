...
function run_lightgallery() {
    ...
    if (image_popup) {
        ...
        $('.clearfix').lightGallery({
            selector: '.dmd-light-gallery-item',
            share: false,
            exThumbImage: 'href',
            download: Dconfig.LG.download,
            getCaptionFromTitleOrAlt: Dconfig.LG.getCaptionFromTitleOrAlt,
            controls: Dconfig.LG.controls,
            keyPress: Dconfig.LG.keyPress,
            escKey: Dconfig.LG.escKey,
            loop: Dconfig.LG.loop,
            autoplay: Dconfig.LG.autoplay,
            thumbnail: Dconfig.LG.thumbnail,
            autoplayControls: Dconfig.LG.autoplayControls
        });
